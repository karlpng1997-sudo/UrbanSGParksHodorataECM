...
path<- 'C:/Users/karlp/OneDrive/Desktop/Test'
...
write.csv(taxa, "taxa.csv", row.names = FALSE) #Add left column to label numbers
...
# To note: Add Sample Names to OTUs in the OTU_table.csv and save as new file
...
# To note: Add a column with consecutive numbers in the taxa.csv and save as new file
...
# Load the table
# To note: remove top left entry in the OTU_table_GenusSpecies_renamed_old.csv and save as new file with a different name below
...
# To note: remove top left entry in the OTU_table_GenusSpecies_renumbered_by_genus_order_old.csv and save as new file with a different name below
...
# Load proportion or count table
...
# Read data
# Added * to Non-ECM Fungi in OTU_table_ECM_and_nonECM_old.csv and saved as new file
...
# In OTU_table_ECM_and_nonECM.csv, need to amend names of OTUs accordingly
...
group_colors <- c('Clavulina_OTU01' = 'red',
                  ...
                  'Tomentella_OTU14_parmastoana' = 'grey85',
                  '*Non-ECM fungi' = 'beige')
...
## Load data with alpha diversity measured and added into new file
